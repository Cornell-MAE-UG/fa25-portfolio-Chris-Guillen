...
### Table of Contents
- [O3 — Client Pitch](#client-pitch)
- [O5 — Functional Prototype](#functional-prototype)
- [O6 — Client Report](#client-report)
...
- Device bounding box ≤ 6 × 6 × 10 inches, weight ≤ 4 lbs

---

## Client Report

[Download Full Report (PDF)]({{ "/assets/ODP%206_%20Client%20Report-combined.pdf" | relative_url }}){:target="_blank"}
...
**Prototype cost: $195.56 — within the $350 budget.**
...
| High | **Compactness** — reduce overall bounding box; current prototype exceeds the 6 × 6 × 10 in. target and would benefit from a shorter housing and integrated motor mount |
